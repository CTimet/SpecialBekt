package io.github.ctimet.specialbekt.data.stickdata;

import io.github.ctimet.specialbekt.BektMain;
import io.github.ctimet.specialbekt.data.util.Data;
import io.github.ctimet.specialbekt.data.util.FileData;
import io.github.ctimet.specialbekt.data.util.SQLData;
import io.github.ctimet.specialbekt.log.ExceptionHandler;
import io.github.ctimet.specialbekt.log.Log;
import io.github.ctimet.specialbekt.plugin.PluginTask;
...
public class StickData {
    ...
    public static class FileDataSave {
        ...
        public static void startTimer() {
            ...
            if (TIMER_DELAY < 0) {
                Log.warn("警告：config.yml中设置的delay小于0，specialbekt已自动将delay设置为初始值10");
                TIMER_DELAY = 10 * 60 * 1000;
                cfg.setValue("timer.delay",10);
                cfg.save();
            }
            if (TIMER_PERIOD <= 0) {
                Log.warn("警告：config.yml中设置的period值过小，specialbekt已自动将period设置为初始值10");
